...
class FletArtifactsTests(unittest.TestCase):
    ...
    def test_flet_main_uses_worker_and_camera(self):
        ...
        self.assertIn("make_snapshot", main)
        self.assertIn("snapshot_to_capture", main)
        self.assertIn("retry_pending_snapshots", main)
