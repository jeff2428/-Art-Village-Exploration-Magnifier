...
class FletArtifactsTests(unittest.TestCase):
    ...
    def test_flet_app_has_magnifier_handle_callbacks(self):
        ...
        self.assertNotIn("on_room_in", handle)
        self.assertNotIn("on_room_out", handle)
    ...
    def test_flet_main_uses_worker_and_camera(self):
        ...
        self.assertIn("on_scale_start=on_pinch_start", main)
        self.assertIn("on_scale_update=on_pinch_update", main)
