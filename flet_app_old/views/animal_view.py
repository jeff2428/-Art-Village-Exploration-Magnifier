...
from ui_theme import CARD_RADIUS, PILL_RADIUS, THEME, interactive_card, section_label
...
def animal_card(
    ...
    if portrait_src:
        portrait_preview = ft.Container(
            width=78, height=78, border_radius=CARD_RADIUS, clip_behavior=ft.ClipBehavior.HARD_EDGE,
            content=ft.Image(src=portrait_src, fit=ft.BoxFit.COVER),
        )
    else:
        portrait_preview = ft.Container(
            width=78, height=78, border_radius=CARD_RADIUS,
